...
create table if not EXISTS plants(
    ...
    constraint CHK_plant check (plant_size in ('XS','S','M','L') 
        ...
        --('pet safe','child safe' ,'poisonous sap','not pet safe ','not child safe' ,'safe (both pet and child)','pollen','dust')                      
...
INSERT into recipents(recipients_id, recipients_first_name, recipients_home_id, recipients_plant_id, email)
VALUES
