...
<html lang="en">
  ...
  <body>
    <main>
        <h3>Please enter some data we need to find the perfect plant for them.</h3>  
        <br>
        <br>
...
<br><br>
        ...
        <h1>How often are they home?</h1>
        <h2>(This is used to determine how much they are able to water a plant)</h2>
   ...
   <br><br><br>
        ...
        <h1>How many kids do they have?</h1>
        ...
        <ul class="quiz">
            ...
            <h1>How many pets do they have?</h1>
            <li>
                <ul class="choices">
                    <li>
                        <label
            ...
            <h1>How much sunlight do they get in their home?</h1>
            <li>
                <ul class="choices">
                    <li>
                        <label
            ...
            <h1>Do they have a plant size preference?</h1>
                    <li>
...
<br><br><br>
        ...
        <h1>How difficult do they want this plant to be?</h1>
